<div class="page-content col-xs-12 col-md-8 col-md-offset-2">
	...
	foreach ( $books->sites as $book ) {
		if ( get_blog_option( $book->blog_id, 'opentextbook_publisher_in_catalog' ) ) {
		...
		<div id="book-<?php echo $book->blog_id; ?>" class="book">
			...
			<footer class="footer">
				...
				<div class="button-wrap">
					<a href="//<?php echo $book->domain . $book->path; ?>" class="btn btn-primary"><?php _e( 'Read More', 'opentextbook' ); ?></a>
				</div>
